...
cyclr_is_hidden | Indicates if the custom field should be hidden when part of a request. Often used in conjuction with a default value (cyclr_default_value) *(optional)*
